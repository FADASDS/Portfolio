...
# Form implementation generated from reading ui file 'c:\Users\fadas\7 семестр\ИЗ\project\ui\Lab3Form — копия.ui'
#
...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.keyTable = QtWidgets.QTableWidget(Form)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.keyTable.sizePolicy().hasHeightForWidth())
        self.keyTable.setSizePolicy(sizePolicy)
        self.keyTable.setMaximumSize(QtCore.QSize(125, 125))
        self.keyTable.setObjectName("keyTable")
        self.keyTable.setColumnCount(3)
        self.keyTable.setRowCount(3)
        item = QtWidgets.QTableWidgetItem()
        ...
        item = QtWidgets.QTableWidgetItem()
        self.keyTable.setItem(0, 1, item)
        item = QtWidgets.QTableWidgetItem()
        self.keyTable.setItem(0, 2, item)
        item = QtWidgets.QTableWidgetItem()
        self.keyTable.setItem(1, 0, item)
        item = QtWidgets.QTableWidgetItem()
        self.keyTable.setItem(1, 1, item)
        item = QtWidgets.QTableWidgetItem()
        self.keyTable.setItem(1, 2, item)
        item = QtWidgets.QTableWidgetItem()
        self.keyTable.setItem(2, 0, item)
        item = QtWidgets.QTableWidgetItem()
        self.keyTable.setItem(2, 1, item)
        item = QtWidgets.QTableWidgetItem()
        self.keyTable.setItem(2, 2, item)
        self.keyTable.horizontalHeader().setDefaultSectionSize(30)
        self.keyTable.horizontalHeader().setMinimumSectionSize(30)
        self.horizontalLayout_6.addWidget(self.keyTable)
    ...
    def retranslateUi(self, Form):
        ...
        self.label.setText(_translate("Form", "Метод умножения матриц"))
        ...
        self.label_8.setText(_translate("Form", "Ключ"))
        ...
        item.setText(_translate("Form", "1"))
        item = self.keyTable.item(0, 1)
        item.setText(_translate("Form", "2"))
        item = self.keyTable.item(0, 2)
        item.setText(_translate("Form", "3"))
        item = self.keyTable.item(1, 0)
        item.setText(_translate("Form", "8"))
        item = self.keyTable.item(1, 1)
        item.setText(_translate("Form", "5"))
        item = self.keyTable.item(1, 2)
        item.setText(_translate("Form", "9"))
        item = self.keyTable.item(2, 0)
        item.setText(_translate("Form", "4"))
        item = self.keyTable.item(2, 1)
        item.setText(_translate("Form", "2"))
        item = self.keyTable.item(2, 2)
        item.setText(_translate("Form", "1"))
